...
Referenced from [0.foundational-research.md](./0.foundational-research.md). Source: https://help.blotato.com/api
(fetched 2026-09-04).
...
This plan targets NestJS on the Fastify adapter (0.foundational-research.md §1.5) — same HTTP
