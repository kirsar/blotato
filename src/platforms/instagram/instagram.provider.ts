...
import type { FetchedComment, FetchedPage, ICommentReader, ICommentWriter } from '../comment-provider.contract';
...
import { PlatformProvider } from '../platform-provider.decorator';
